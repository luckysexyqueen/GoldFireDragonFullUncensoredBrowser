...
export declare function findSourceMap(_path: string): undefined;
...
export declare namespace Module {
    ...
    var findSourceMap: typeof import("./module").findSourceMap;
    var SourceMap: typeof import("./module").SourceMap;
