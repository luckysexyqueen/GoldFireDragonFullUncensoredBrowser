export declare function getNativePromiseConstructor(): typeof Promise;
export declare function installAsyncContext(): void;
...
declare const _default: {
    ...
    installAsyncContext: typeof installAsyncContext;
};
