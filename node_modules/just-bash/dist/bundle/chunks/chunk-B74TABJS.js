...
`)&&(s|=this.EMPTY_END_LINE),this.isWordRune(t)!==this.isWordRune(e)?s|=this.EMPTY_WORD_BOUNDARY:s|=this.EMPTY_NO_WORD_BOUNDARY,s}static quoteMeta(t){return t.split("").map(e=>this.METACHARACTERS.indexOf(e)>=0?`\\${e}`:e).join("")}static charCount(t){return t>w.MAX_BMP?2:1}static stringToUtf8ByteArray(t){if(globalThis.TextEncoder)return Array.from(new TextEncoder().encode(t));{let e=[],s=0;for(let n=0;n<t.length;n++){let r=t.charCodeAt(n);r<128?e[s++]=r:r<2048?(e[s++]=r>>6|192,e[s++]=r&63|128):(r&64512)===55296&&n+1<t.length&&(t.charCodeAt(n+1)&64512)===56320?(r=65536+((r&1023)<<10)+(t.charCodeAt(++n)&1023),e[s++]=r>>18|240,e[s++]=r>>12&63|128,e[s++]=r>>6&63|128,e[s++]=r&63|128):(e[s++]=r>>12|224,e[s++]=r>>6&63|128,e[s++]=r&63|128)}return e}}static utf8ByteArrayToString(t){if(globalThis.TextDecoder)return new TextDecoder("utf-8").decode(new Uint8Array(t));{let e=[],s=0,n=0;for(;s<t.length;){let r=t[s++];if(r<128)e[n++]=String.fromCharCode(r);else if(r>191&&r<224){let a=t[s++];e[n++]=String.fromCharCode((r&31)<<6|a&63)}else if(r>239&&r<365){let a=t[s++],o=t[s++],h=t[s++],p=((r&7)<<18|(a&63)<<12|(o&63)<<6|h&63)-65536;e[n++]=String.fromCharCode(55296+(p>>10)),e[n++]=String.fromCharCode(56320+(p&1023))}else{let a=t[s++],o=t[s++];e[n++]=String.fromCharCode((r&15)<<12|(a&63)<<6|o&63)}}return e.join("")}}},N1=(i=[],t=0)=>{let e={};for(let s=0;s<i.length;s++){let n=i[s],r=t+s;e[n]=r,e[r]=n}return Object.freeze(e)},I=class i{static Encoding=N1(["UTF_16","UTF_8"]);getEncoding(){throw Error("not implemented")}isUTF8Encoding(){return this.getEncoding()===i.Encoding.UTF_8}isUTF16Encoding(){return this.getEncoding()===i.Encoding.UTF_16}},F=class extends I{constructor(t=null){super(),this.bytes=t}getEncoding(){return I.Encoding.UTF_8}asCharSequence(){return C.utf8ByteArrayToString(this.bytes)}asBytes(){return this.bytes}length(){return this.bytes.length}},v=class extends I{constructor(t=null){super(),this.charSequence=t}getEncoding(){return I.Encoding.UTF_16}asCharSequence(){return this.charSequence}asBytes(){return this.charSequence.toString().split("").map(t=>t.codePointAt(0))}length(){return this.charSequence.length}},_=class{static utf16(t){return new v(t)}static utf8(t){return Array.isArray(t)?new F(t):new F(C.stringToUtf8ByteArray(t))}},L=class{static EOF(){return-8}canCheckPrefix(){return!0}endPos(){return this.end}},z=class extends L{constructor(t,e=0,s=t.length){super(),this.bytes=t,this.start=e,this.end=s}step(t){if(t+=this.start,t>=this.end)return L.EOF();let e=this.bytes[t++]&255;return(e&128)===0?e<<3|1:(e&224)===192?(e=e&31,t>=this.end?L.EOF():(e=e<<6|this.bytes[t++]&63,e<<3|2)):(e&240)===224?(e=e&15,t+1>=this.end?L.EOF():(e=e<<6|this.bytes[t++]&63,e=e<<6|this.bytes[t++]&63,e<<3|3)):(e=e&7,t+2>=this.end?L.EOF():(e=e<<6|this.bytes[t++]&63,e=e<<6|this.bytes[t++]&63,e=e<<6|this.bytes[t++]&63,e<<3|4))}index(t,e){e+=this.start;let s=this.indexOf(this.bytes,t.prefixUTF8,e);return s<0?s:s-e}context(t){t+=this.start;let e=-1;if(t>this.start&&t<=this.end){let n=t-1;if(e=this.bytes[n--],e>=128){let r=t-4;for(r<this.start&&(r=this.start);n>=r&&(this.bytes[n]&192)===128;)n--;n<this.start&&(n=this.start),e=this.step(n)>>3}}let s=t<this.end?this.step(t)>>3:-1;return C.emptyOpContext(e,s)}indexOf(t,e,s=0){let n=e.length;if(n===0)return-1;let r=t.length;for(let a=s;a<=r-n;a++)for(let o=0;o<n&&t[a+o]===e[o];o++)if(o===n-1)return a;return-1}},$=class extends L{constructor(t,e=0,s=t.length){super(),this.charSequence=t,this.start=e,this.end=s}step(t){if(t+=this.start,t<this.end){let e=this.charSequence.codePointAt(t);return e<<3|C.charCount(e)}else return L.EOF()}index(t,e){e+=this.start;let s=this.charSequence.indexOf(t.prefix,e);return s<0?s:s-e}context(t){t+=this.start;let e=t>0&&t<=this.charSequence.length?this.charSequence.codePointAt(t-1):-1,s=t<this.charSequence.length?this.charSequence.codePointAt(t):-1;return C.emptyOpContext(e,s)}},R=class{static fromUTF8(t,e=0,s=t.length){return new z(t,e,s)}static fromUTF16(t,e=0,s=t.length){return new $(t,e,s)}},P=class extends Error{constructor(t){super(t),this.name="RE2JSException"}},m=class extends P{constructor(t,e=null){let s=`error parsing regexp: ${t}`;e&&(s+=`: \`${e}\``),super(s),this.name="RE2JSSyntaxException",this.message=s,this.error=t,this.input=e}getDescription(){return this.error}getPattern(){return this.input}},j=class extends P{constructor(t){super(t),this.name="RE2JSCompileException"}},U=class extends P{constructor(t){super(t),this.name="RE2JSGroupException"}},V=class extends P{constructor(t){super(t),this.name="RE2JSFlagsException"}},B=class{static quoteReplacement(t,e=!1){return e?t.indexOf("\\")<0&&t.indexOf("$")<0?t:t.split("").map(s=>{let n=s.codePointAt(0);return n===u.CODES.get("\\")||n===u.CODES.get("$")?`\\${s}`:s}).join(""):t.indexOf("$")<0?t:t.split("").map(s=>s.codePointAt(0)===u.CODES.get("$")?"$$":s).join("")}constructor(t,e){if(t===null)throw new Error("pattern is null");this.patternInput=t;let s=this.patternInput.re2();this.patternGroupCount=s.numberOfCapturingGroups(),this.groups=[],this.namedGroups=s.namedGroups,this.numberOfInstructions=s.numberOfInstructions(),e instanceof I?this.resetMatcherInput(e):Array.isArray(e)?this.resetMatcherInput(_.utf8(e)):this.resetMatcherInput(_.utf16(e))}pattern(){return this.patternInput}reset(){return this.matcherInputLength=this.matcherInput.length(),this.appendPos=0,this.hasMatch=!1,this.hasGroups=!1,this.anchorFlag=0,this}resetMatcherInput(t){if(t===null)throw new Error("input is null");return this.matcherInput=t,this.reset(),this}start(t=0){if(typeof t=="string"){let e=this.namedGroups[t];if(!Number.isFinite(e))throw new U(`group '${t}' not found`);t=e}return this.loadGroup(t),this.groups[2*t]}end(t=0){if(typeof t=="string"){let e=this.namedGroups[t];if(!Number.isFinite(e))throw new U(`group '${t}' not found`);t=e}return this.loadGroup(t),this.groups[2*t+1]}programSize(){return this.numberOfInstructions}group(t=0){if(typeof t=="string"){let n=this.namedGroups[t];if(!Number.isFinite(n))throw new U(`group '${t}' not found`);t=n}let e=this.start(t),s=this.end(t);return e<0&&s<0?null:this.substring(e,s)}groupCount(){return this.patternGroupCount}loadGroup(t){if(t<0||t>this.patternGroupCount)throw new U(`Group index out of bounds: ${t}`);if(!this.hasMatch)throw new U("perhaps no match attempted");if(t===0||this.hasGroups)return;let e=this.groups[1]+1;e>this.matcherInputLength&&(e=this.matcherInputLength);let s=this.patternInput.re2().matchMachineInput(this.matcherInput,this.groups[0],e,this.anchorFlag,1+this.patternGroupCount);if(!s[0])throw new U("inconsistency in matching group data");this.groups=s[1],this.hasGroups=!0}matches(){return this.genMatch(0,g.ANCHOR_BOTH)}lookingAt(){return this.genMatch(0,g.ANCHOR_START)}find(t=null){if(t!==null){if(t<0||t>this.matcherInputLength)throw new U(`start index out of bounds: ${t}`);return this.reset(),this.genMatch(t,0)}return t=0,this.hasMatch&&(t=this.groups[1],this.groups[0]===this.groups[1]&&t++),this.genMatch(t,g.UNANCHORED)}genMatch(t,e){let s=this.patternInput.re2().matchMachineInput(this.matcherInput,t,this.matcherInputLength,e,1);return s[0]?(this.groups=s[1],this.hasMatch=!0,this.hasGroups=!1,this.anchorFlag=e,!0):!1}substring(t,e){return this.matcherInput.isUTF8Encoding()?C.utf8ByteArrayToString(this.matcherInput.asBytes().slice(t,e)):this.matcherInput.asCharSequence().substring(t,e).toString()}inputLength(){return this.matcherInputLength}appendReplacement(t,e=!1){let s="",n=this.start(),r=this.end();return this.appendPos<n&&(s+=this.substring(this.appendPos,n)),this.appendPos=r,s+=e?this.appendReplacementInternalJava(t):this.appendReplacementInternalJs(t),s}appendReplacementInternalJava(t){let e="",s=0,n=t.length;for(let r=0;r<n-1;r++){if(t.codePointAt(r)===u.CODES.get("\\")){s<r&&(e+=t.substring(s,r)),r++,s=r;continue}if(t.codePointAt(r)===u.CODES.get("$")){let a=t.codePointAt(r+1);if(u.CODES.get("0")<=a&&a<=u.CODES.get("9")){let o=a-u.CODES.get("0");for(s<r&&(e+=t.substring(s,r)),r+=2;r<n&&(a=t.codePointAt(r),!(a<u.CODES.get("0")||a>u.CODES.get("9")||o*10+a-u.CODES.get("0")>this.patternGroupCount));r++)o=o*10+a-u.CODES.get("0");if(o>this.patternGroupCount)throw new U(`n > number of groups: ${o}`);let h=this.group(o);h!==null&&(e+=h),s=r,r--;continue}else if(a===u.CODES.get("{")){s<r&&(e+=t.substring(s,r)),r++;let o=r+1;for(;o<t.length&&t.codePointAt(o)!==u.CODES.get("}")&&t.codePointAt(o)!==u.CODES.get(" ");)o++;if(o===t.length||t.codePointAt(o)!==u.CODES.get("}"))throw new U("named capture group is missing trailing '}'");let h=t.substring(r+1,o);e+=this.group(h),s=o+1}}}return s<n&&(e+=t.substring(s,n)),e}appendReplacementInternalJs(t){let e="",s=0,n=t.length;for(let r=0;r<n-1;r++)if(t.codePointAt(r)===u.CODES.get("$")){let a=t.codePointAt(r+1);if(u.CODES.get("$")===a){s<r&&(e+=t.substring(s,r)),e+="$",r++,s=r+1;continue}else if(u.CODES.get("&")===a){s<r&&(e+=t.substring(s,r));let o=this.group(0);o!==null?e+=o:e+="$&",r++,s=r+1;continue}else if(u.CODES.get("1")<=a&&a<=u.CODES.get("9")){let o=a-u.CODES.get("0");for(s<r&&(e+=t.substring(s,r)),r+=2;r<n&&(a=t.codePointAt(r),!(a<u.CODES.get("0")||a>u.CODES.get("9")||o*10+a-u.CODES.get("0")>this.patternGroupCount));r++)o=o*10+a-u.CODES.get("0");if(o>this.patternGroupCount){e+=`$${o}`,s=r,r--;continue}let h=this.group(o);h!==null&&(e+=h),s=r,r--;continue}else if(a===u.CODES.get("<")){s<r&&(e+=t.substring(s,r)),r++;let o=r+1;for(;o<t.length&&t.codePointAt(o)!==u.CODES.get(">")&&t.codePointAt(o)!==u.CODES.get(" ");)o++;if(o===t.length||t.codePointAt(o)!==u.CODES.get(">")){e+=t.substring(r-1,o+1),s=o+1;continue}let h=t.substring(r+1,o);Object.prototype.hasOwnProperty.call(this.namedGroups,h)?e+=this.group(h):e+=`$<${h}>`,s=o+1}}return s<n&&(e+=t.substring(s,n)),e}appendTail(){return this.substring(this.appendPos,this.matcherInputLength)}replaceAll(t,e=!1){return this.replace(t,!0,e)}replaceFirst(t,e=!1){return this.replace(t,!1,e)}replace(t,e=!0,s=!1){let n="";for(this.reset();this.find()&&(n+=this.appendReplacement(t,s),!!e););return n+=this.appendTail(),n}},E=class i{static ALT=1;static ALT_MATCH=2;static CAPTURE=3;static EMPTY_WIDTH=4;static FAIL=5;static MATCH=6;static NOP=7;static RUNE=8;static RUNE1=9;static RUNE_ANY=10;static RUNE_ANY_NOT_NL=11;static isRuneOp(t){return i.RUNE<=t&&t<=i.RUNE_ANY_NOT_NL}static escapeRunes(t){let e='"';for(let s of t)e+=C.escapeRune(s);return e+='"',e}constructor(t){this.op=t,this.out=0,this.arg=0,this.runes=[]}matchRune(t){if(this.runes.length===1){let n=this.runes[0];return(this.arg&g.FOLD_CASE)!==0?w.equalsIgnoreCase(n,t):t===n}for(let n=0;n<this.runes.length&&n<=8;n+=2){if(t<this.runes[n])return!1;if(t<=this.runes[n+1])return!0}let e=0,s=this.runes.length/2|0;for(;e<s;){let n=e+((s-e)/2|0);if(this.runes[2*n]<=t){if(t<=this.runes[2*n+1])return!0;e=n+1}else s=n}return!1}toString(){switch(this.op){case i.ALT:return`alt -> ${this.out}, ${this.arg}`;case i.ALT_MATCH:return`altmatch -> ${this.out}, ${this.arg}`;case i.CAPTURE:return`cap ${this.arg} -> ${this.out}`;case i.EMPTY_WIDTH:return`empty ${this.arg} -> ${this.out}`;case i.MATCH:return"match";case i.FAIL:return"fail";case i.NOP:return`nop -> ${this.out}`;case i.RUNE:return this.runes===null?"rune <null>":["rune ",i.escapeRunes(this.runes),(this.arg&g.FOLD_CASE)!==0?"/i":""," -> ",this.out].join("");case i.RUNE1:return`rune1 ${i.escapeRunes(this.runes)} -> ${this.out}`;case i.RUNE_ANY:return`any -> ${this.out}`;case i.RUNE_ANY_NOT_NL:return`anynotnl -> ${this.out}`;default:throw new Error("unhandled case in Inst.toString")}}},q=class{constructor(){this.inst=null,this.cap=[]}},Y=class{constructor(){this.sparse=[],this.densePcs=[],this.denseThreads=[],this.size=0}contains(t){let e=this.sparse[t];return e<this.size&&this.densePcs[e]===t}isEmpty(){return this.size===0}add(t){let e=this.size++;return this.sparse[t]=e,this.denseThreads[e]=null,this.densePcs[e]=t,e}clear(){this.sparse=[],this.densePcs=[],this.denseThreads=[],this.size=0}toString(){let t="{";for(let e=0;e<this.size;e++)e!==0&&(t+=", "),t+=this.densePcs[e];return t+="}",t}},M=class i{static fromRE2(t){let e=new i;return e.prog=t.prog,e.re2=t,e.q0=new Y(e.prog.numInst()),e.q1=new Y(e.prog.numInst()),e.pool=[],e.poolSize=0,e.matched=!1,e.matchcap=Array(e.prog.numCap<2?2:e.prog.numCap).fill(0),e.ncap=0,e}static fromMachine(t){let e=new i;return e.re2=t.re2,e.prog=t.prog,e.q0=t.q0,e.q1=t.q1,e.pool=t.pool,e.poolSize=t.poolSize,e.matched=t.matched,e.matchcap=t.matchcap,e.ncap=t.ncap,e}init(t){this.ncap=t,t>this.matchcap.length?this.initNewCap(t):this.resetCap(t)}resetCap(t){for(let e=0;e<this.poolSize;e++){let s=this.pool[e];s.cap=Array(t).fill(0)}}initNewCap(t){for(let e=0;e<this.poolSize;e++){let s=this.pool[e];s.cap=Array(t).fill(0)}this.matchcap=Array(t).fill(0)}submatches(){return this.ncap===0?C.emptyInts():this.matchcap.slice(0,this.ncap)}alloc(t){let e;return this.poolSize>0?(this.poolSize--,e=this.pool[this.poolSize]):e=new q,e.inst=t,e}freeQueue(t,e=0){let s=t.size-e,n=this.poolSize+s;this.pool.length<n&&(this.pool=this.pool.slice(0,Math.max(this.pool.length*2,n)));for(let r=e;r<t.size;r++){let a=t.denseThreads[r];a!==null&&(this.pool[this.poolSize]=a,this.poolSize++)}t.clear()}freeThread(t){this.pool.length<=this.poolSize&&(this.pool=this.pool.slice(0,this.pool.length*2)),this.pool[this.poolSize]=t,this.poolSize++}match(t,e,s){let n=this.re2.cond;if(n===C.EMPTY_ALL||(s===g.ANCHOR_START||s===g.ANCHOR_BOTH)&&e!==0)return!1;this.matched=!1,this.matchcap=Array(this.prog.numCap).fill(-1);let r=this.q0,a=this.q1,o=t.step(e),h=o>>3,p=o&7,f=-1,A=0;o!==L.EOF()&&(o=t.step(e+p),f=o>>3,A=o&7);let N;for(e===0?N=C.emptyOpContext(-1,h):N=t.context(e);;){if(r.isEmpty()){if((n&C.EMPTY_BEGIN_TEXT)!==0&&e!==0||this.matched)break;if(this.re2.prefix.length!==0&&f!==this.re2.prefixRune&&t.canCheckPrefix()){let T=t.index(this.re2,e);if(T<0)break;e+=T,o=t.step(e),h=o>>3,p=o&7,o=t.step(e+p),f=o>>3,A=o&7}}!this.matched&&(e===0||s===g.UNANCHORED)&&(this.ncap>0&&(this.matchcap[0]=e),this.add(r,this.prog.start,e,this.matchcap,N,null));let O=e+p;if(N=t.context(O),this.step(r,a,e,O,h,N,s,e===t.endPos()),p===0||this.ncap===0&&this.matched)break;e+=p,h=f,p=A,h!==-1&&(o=t.step(e+p),f=o>>3,A=o&7);let S=r;r=a,a=S}return this.freeQueue(a),this.matched}step(t,e,s,n,r,a,o,h){let p=this.re2.longest;for(let f=0;f<t.size;f++){let A=t.denseThreads[f];if(A===null)continue;if(p&&this.matched&&this.ncap>0&&this.matchcap[0]<A.cap[0]){this.freeThread(A);continue}let N=A.inst,O=!1;switch(N.op){case E.MATCH:if(o===g.ANCHOR_BOTH&&!h)break;this.ncap>0&&(!p||!this.matched||this.matchcap[1]<s)&&(A.cap[1]=s,this.matchcap=A.cap.slice(0,this.ncap)),p||this.freeQueue(t,f+1),this.matched=!0;break;case E.RUNE:O=N.matchRune(r);break;case E.RUNE1:O=r===N.runes[0];break;case E.RUNE_ANY:O=!0;break;case E.RUNE_ANY_NOT_NL:O=r!==u.CODES.get(`
`);break;default:throw new Error("bad inst")}O&&(A=this.add(e,N.out,n,A.cap,a,A)),A!==null&&(this.freeThread(A),t.denseThreads[f]=null)}t.clear()}add(t,e,s,n,r,a){if(e===0||t.contains(e))return a;let o=t.add(e),h=this.prog.inst[e];switch(h.op){case E.FAIL:break;case E.ALT:case E.ALT_MATCH:a=this.add(t,h.out,s,n,r,a),a=this.add(t,h.arg,s,n,r,a);break;case E.EMPTY_WIDTH:(h.arg&~r)===0&&(a=this.add(t,h.out,s,n,r,a));break;case E.NOP:a=this.add(t,h.out,s,n,r,a);break;case E.CAPTURE:if(h.arg<this.ncap){let p=n[h.arg];n[h.arg]=s,this.add(t,h.out,s,n,r,null),n[h.arg]=p}else a=this.add(t,h.out,s,n,r,a);break;case E.MATCH:case E.RUNE:case E.RUNE1:case E.RUNE_ANY:case E.RUNE_ANY_NOT_NL:a===null?a=this.alloc(h):a.inst=h,this.ncap>0&&a.cap!==n&&(a.cap=n.slice(0,this.ncap)),t.denseThreads[o]=a,a=null;break;default:throw new Error("unhandled")}return a}},b1=i=>{let t=-2128831035;for(let e=0;e<i.length;e++)t^=i[e],t=Math.imul(t,16777619);return t},U1=(i,t)=>{if(i.length!==t.length)return!1;for(let e=0;e<i.length;e++)if(i[e]!==t[e])return!1;return!0},W=class{constructor(t,e){this.nfaStates=t,this.isMatch=e,this.nextAscii=new Array(w.MAX_ASCII+1).fill(null),this.nextMap=new Map}},K=class{constructor(t){this.prog=t,this.stateCache=new Map,this.stateCount=0,this.startState=null,this.stateLimit=1e4}computeClosure(t){let e=new Set,s=[...t],n=!1;for(;s.length>0;){let a=s.pop();if(e.has(a))continue;e.add(a);let o=this.prog.getInst(a);switch(o.op){case E.MATCH:n=!0;break;case E.ALT:case E.ALT_MATCH:s.push(o.out),s.push(o.arg);break;case E.NOP:case E.CAPTURE:s.push(o.out);break;case E.EMPTY_WIDTH:return null}}return{pcs:Int32Array.from(e).sort(),isMatch:n}}getState(t){let e=this.computeClosure(t);if(!e)return null;let s=e.pcs,n=b1(s),r=this.stateCache.get(n);if(r)for(let o=0;o<r.length;o++){let h=r[o];if(U1(h.nfaStates,s))return h}else r=[],this.stateCache.set(n,r);if(this.stateCount>=this.stateLimit)return this.stateCache.clear(),this.stateCount=0,this.startState=null,null;let a=new W(s,e.isMatch);return r.push(a),this.stateCount++,a}step(t,e,s){if(s===g.UNANCHORED&&e<=w.MAX_ASCII){let a=t.nextAscii[e];if(a!==null)return a}else{let a=e+(s===g.UNANCHORED?0:w.MAX_RUNE+1);if(t.nextMap.has(a))return t.nextMap.get(a)}let n=[];for(let a=0;a<t.nfaStates.length;a++){let o=t.nfaStates[a],h=this.prog.getInst(o);E.isRuneOp(h.op)&&h.matchRune(e)&&n.push(h.out)}s===g.UNANCHORED&&n.push(this.prog.start);let r=this.getState(n);if(s===g.UNANCHORED&&e<=w.MAX_ASCII)t.nextAscii[e]=r;else{let a=e+(s===g.UNANCHORED?0:w.MAX_RUNE+1);t.nextMap.set(a,r)}return r}match(t,e,s){if((s===g.ANCHOR_START||s===g.ANCHOR_BOTH)&&e!==0)return!1;if(!this.startState&&(this.startState=this.getState([this.prog.start]),!this.startState))return null;let n=t.endPos(),r=this.startState;if(r.isMatch)if(s===g.ANCHOR_BOTH){if(e===n)return!0}else return!0;let a=e;for(;a<n;){let o=t.step(a),h=o>>3,p=o&7;if(p===0)break;if(r=this.step(r,h,s),r===null)return null;if(r.isMatch)if(s===g.ANCHOR_BOTH){if(a+p===n)return!0}else return!0;if(r.nfaStates.length===0&&s!==g.UNANCHORED)return!1;a+=p}return!1}},c=class i{static Op=N1(["NO_MATCH","EMPTY_MATCH","LITERAL","CHAR_CLASS","ANY_CHAR_NOT_NL","ANY_CHAR","BEGIN_LINE","END_LINE","BEGIN_TEXT","END_TEXT","WORD_BOUNDARY","NO_WORD_BOUNDARY","CAPTURE","STAR","PLUS","QUEST","REPEAT","CONCAT","ALTERNATE","LEFT_PAREN","VERTICAL_BAR"]);static isPseudoOp(t){return t>=i.Op.LEFT_PAREN}static emptySubs(){return[]}static quoteIfHyphen(t){return t===u.CODES.get("-")?"\\":""}static fromRegexp(t){let e=new i(t.op);return e.flags=t.flags,e.subs=t.subs,e.runes=t.runes,e.cap=t.cap,e.min=t.min,e.max=t.max,e.name=t.name,e.namedGroups=t.namedGroups,e}constructor(t){this.op=t,this.flags=0,this.subs=i.emptySubs(),this.runes=[],this.min=0,this.max=0,this.cap=0,this.name=null,this.namedGroups={}}reinit(){this.flags=0,this.subs=i.emptySubs(),this.runes=[],this.cap=0,this.min=0,this.max=0,this.name=null,this.namedGroups={}}toString(){return this.appendTo()}appendTo(){let t="";switch(this.op){case i.Op.NO_MATCH:t+="[^\\x00-\\x{10FFFF}]";break;case i.Op.EMPTY_MATCH:t+="(?:)";break;case i.Op.STAR:case i.Op.PLUS:case i.Op.QUEST:case i.Op.REPEAT:{let e=this.subs[0];switch(e.op>i.Op.CAPTURE||e.op===i.Op.LITERAL&&e.runes.length>1?t+=`(?:${e.appendTo()})`:t+=e.appendTo(),this.op){case i.Op.STAR:t+="*";break;case i.Op.PLUS:t+="+";break;case i.Op.QUEST:t+="?";break;case i.Op.REPEAT:t+=`{${this.min}`,this.min!==this.max&&(t+=",",this.max>=0&&(t+=this.max)),t+="}";break}(this.flags&g.NON_GREEDY)!==0&&(t+="?");break}case i.Op.CONCAT:{for(let e of this.subs)e.op===i.Op.ALTERNATE?t+=`(?:${e.appendTo()})`:t+=e.appendTo();break}case i.Op.ALTERNATE:{let e="";for(let s of this.subs)t+=e,e="|",t+=s.appendTo();break}case i.Op.LITERAL:(this.flags&g.FOLD_CASE)!==0&&(t+="(?i:");for(let e of this.runes)t+=C.escapeRune(e);(this.flags&g.FOLD_CASE)!==0&&(t+=")");break;case i.Op.ANY_CHAR_NOT_NL:t+="(?-s:.)";break;case i.Op.ANY_CHAR:t+="(?s:.)";break;case i.Op.CAPTURE:this.name===null||this.name.length===0?t+="(":t+=`(?P<${this.name}>`,this.subs[0].op!==i.Op.EMPTY_MATCH&&(t+=this.subs[0].appendTo()),t+=")";break;case i.Op.BEGIN_TEXT:t+="\\A";break;case i.Op.END_TEXT:(this.flags&g.WAS_DOLLAR)!==0?t+="(?-m:$)":t+="\\z";break;case i.Op.BEGIN_LINE:t+="^";break;case i.Op.END_LINE:t+="$";break;case i.Op.WORD_BOUNDARY:t+="\\b";break;case i.Op.NO_WORD_BOUNDARY:t+="\\B";break;case i.Op.CHAR_CLASS:if(this.runes.length%2!==0){t+="[invalid char class]";break}if(t+="[",this.runes.length===0)t+="^\\x00-\\x{10FFFF}";else if(this.runes[0]===0&&this.runes[this.runes.length-1]===w.MAX_RUNE){t+="^";for(let e=1;e<this.runes.length-1;e+=2){let s=this.runes[e]+1,n=this.runes[e+1]-1;t+=i.quoteIfHyphen(s),t+=C.escapeRune(s),s!==n&&(t+="-",t+=i.quoteIfHyphen(n),t+=C.escapeRune(n))}}else for(let e=0;e<this.runes.length;e+=2){let s=this.runes[e],n=this.runes[e+1];t+=i.quoteIfHyphen(s),t+=C.escapeRune(s),s!==n&&(t+="-",t+=i.quoteIfHyphen(n),t+=C.escapeRune(n))}t+="]";break;default:t+=this.op;break}return t}maxCap(){let t=0;if(this.op===i.Op.CAPTURE&&(t=this.cap),this.subs!==null)for(let e of this.subs){let s=e.maxCap();t<s&&(t=s)}return t}equals(t){if(!(t!==null&&t instanceof i)||this.op!==t.op)return!1;switch(this.op){case i.Op.END_TEXT:{if((this.flags&g.WAS_DOLLAR)!==(t.flags&g.WAS_DOLLAR))return!1;break}case i.Op.LITERAL:case i.Op.CHAR_CLASS:{if(this.runes===null&&t.runes===null)break;if(this.runes===null||t.runes===null||this.runes.length!==t.runes.length)return!1;for(let e=0;e<this.runes.length;e++)if(this.runes[e]!==t.runes[e])return!1;break}case i.Op.ALTERNATE:case i.Op.CONCAT:{if(this.subs.length!==t.subs.length)return!1;for(let e=0;e<this.subs.length;++e)if(!this.subs[e].equals(t.subs[e]))return!1;break}case i.Op.STAR:case i.Op.PLUS:case i.Op.QUEST:{if((this.flags&g.NON_GREEDY)!==(t.flags&g.NON_GREEDY)||!this.subs[0].equals(t.subs[0]))return!1;break}case i.Op.REPEAT:{if((this.flags&g.NON_GREEDY)!==(t.flags&g.NON_GREEDY)||this.min!==t.min||this.max!==t.max||!this.subs[0].equals(t.subs[0]))return!1;break}case i.Op.CAPTURE:{if(this.cap!==t.cap||(this.name===null?t.name!==null:this.name!==t.name)||!this.subs[0].equals(t.subs[0]))return!1;break}}return!0}},Z=class{constructor(){this.inst=[],this.start=0,this.numCap=2}getInst(t){return this.inst[t]}numInst(){return this.inst.length}addInst(t){this.inst.push(new E(t))}skipNop(t){let e=this.inst[t];for(;e.op===E.NOP||e.op===E.CAPTURE;)e=this.inst[t],t=e.out;return e}prefix(){let t="",e=this.skipNop(this.start);if(!E.isRuneOp(e.op)||e.runes.length!==1)return[e.op===E.MATCH,t];for(;E.isRuneOp(e.op)&&e.runes.length===1&&(e.arg&g.FOLD_CASE)===0;)t+=String.fromCodePoint(e.runes[0]),e=this.skipNop(e.out);return[e.op===E.MATCH,t]}startCond(){let t=0,e=this.start;t:for(;;){let s=this.inst[e];switch(s.op){case E.EMPTY_WIDTH:t|=s.arg;break;case E.FAIL:return-1;case E.CAPTURE:case E.NOP:break;default:break t}e=s.out}return t}next(t){let e=this.inst[t>>1];return(t&1)===0?e.out:e.arg}patch(t,e){for(;t!==0;){let s=this.inst[t>>1];(t&1)===0?(t=s.out,s.out=e):(t=s.arg,s.arg=e)}}append(t,e){if(t===0)return e;if(e===0)return t;let s=t;for(;;){let r=this.next(s);if(r===0)break;s=r}let n=this.inst[s>>1];return(s&1)===0?n.out=e:n.arg=e,t}toString(){let t="";for(let e=0;e<this.inst.length;e++){let s=t.length;t+=e,e===this.start&&(t+="*"),t+="        ".substring(t.length-s),t+=this.inst[e],t+=`
`}return t}},D=class{constructor(t=0,e=0,s=!1){this.i=t,this.out=e,this.nullable=s}},Q=class i{static ANY_RUNE_NOT_NL(){return[0,u.CODES.get(`
`)-1,u.CODES.get(`
`)+1,w.MAX_RUNE]}static ANY_RUNE(){return[0,w.MAX_RUNE]}static compileRegexp(t){let e=new i,s=e.compile(t);return e.prog.patch(s.out,e.newInst(E.MATCH).i),e.prog.start=s.i,e.prog}constructor(){this.prog=new Z,this.newInst(E.FAIL)}newInst(t){return this.prog.addInst(t),new D(this.prog.numInst()-1,0,!0)}nop(){let t=this.newInst(E.NOP);return t.out=t.i<<1,t}fail(){return new D}cap(t){let e=this.newInst(E.CAPTURE);return e.out=e.i<<1,this.prog.getInst(e.i).arg=t,this.prog.numCap<t+1&&(this.prog.numCap=t+1),e}cat(t,e){return t.i===0||e.i===0?this.fail():(this.prog.patch(t.out,e.i),new D(t.i,e.out,t.nullable&&e.nullable))}alt(t,e){if(t.i===0)return e;if(e.i===0)return t;let s=this.newInst(E.ALT),n=this.prog.getInst(s.i);return n.out=t.i,n.arg=e.i,s.out=this.prog.append(t.out,e.out),s.nullable=t.nullable||e.nullable,s}loop(t,e){let s=this.newInst(E.ALT),n=this.prog.getInst(s.i);return e?(n.arg=t.i,s.out=s.i<<1):(n.out=t.i,s.out=s.i<<1|1),this.prog.patch(t.out,s.i),s}quest(t,e){let s=this.newInst(E.ALT),n=this.prog.getInst(s.i);return e?(n.arg=t.i,s.out=s.i<<1):(n.out=t.i,s.out=s.i<<1|1),s.out=this.prog.append(s.out,t.out),s}star(t,e){return t.nullable?this.quest(this.plus(t,e),e):this.loop(t,e)}plus(t,e){return new D(t.i,this.loop(t,e).out,t.nullable)}empty(t){let e=this.newInst(E.EMPTY_WIDTH);return this.prog.getInst(e.i).arg=t,e.out=e.i<<1,e}rune(t,e){let s=this.newInst(E.RUNE);s.nullable=!1;let n=this.prog.getInst(s.i);return n.runes=t,e&=g.FOLD_CASE,(t.length!==1||w.simpleFold(t[0])===t[0])&&(e&=-2),n.arg=e,s.out=s.i<<1,(e&g.FOLD_CASE)===0&&t.length===1||t.length===2&&t[0]===t[1]?n.op=E.RUNE1:t.length===2&&t[0]===0&&t[1]===w.MAX_RUNE?n.op=E.RUNE_ANY:t.length===4&&t[0]===0&&t[1]===u.CODES.get(`
`)-1&&t[2]===u.CODES.get(`
`)+1&&t[3]===w.MAX_RUNE&&(n.op=E.RUNE_ANY_NOT_NL),s}compile(t){switch(t.op){case c.Op.NO_MATCH:return this.fail();case c.Op.EMPTY_MATCH:return this.nop();case c.Op.LITERAL:if(t.runes.length===0)return this.nop();{let e=null;for(let s of t.runes){let n=this.rune([s],t.flags);e=e===null?n:this.cat(e,n)}return e}case c.Op.CHAR_CLASS:return this.rune(t.runes,t.flags);case c.Op.ANY_CHAR_NOT_NL:return this.rune(i.ANY_RUNE_NOT_NL(),0);case c.Op.ANY_CHAR:return this.rune(i.ANY_RUNE(),0);case c.Op.BEGIN_LINE:return this.empty(C.EMPTY_BEGIN_LINE);case c.Op.END_LINE:return this.empty(C.EMPTY_END_LINE);case c.Op.BEGIN_TEXT:return this.empty(C.EMPTY_BEGIN_TEXT);case c.Op.END_TEXT:return this.empty(C.EMPTY_END_TEXT);case c.Op.WORD_BOUNDARY:return this.empty(C.EMPTY_WORD_BOUNDARY);case c.Op.NO_WORD_BOUNDARY:return this.empty(C.EMPTY_NO_WORD_BOUNDARY);case c.Op.CAPTURE:{let e=this.cap(t.cap<<1),s=this.compile(t.subs[0]),n=this.cap(t.cap<<1|1);return this.cat(this.cat(e,s),n)}case c.Op.STAR:return this.star(this.compile(t.subs[0]),(t.flags&g.NON_GREEDY)!==0);case c.Op.PLUS:return this.plus(this.compile(t.subs[0]),(t.flags&g.NON_GREEDY)!==0);case c.Op.QUEST:return this.quest(this.compile(t.subs[0]),(t.flags&g.NON_GREEDY)!==0);case c.Op.CONCAT:{if(t.subs.length===0)return this.nop();{let e=null;for(let s of t.subs){let n=this.compile(s);e=e===null?n:this.cat(e,n)}return e}}case c.Op.ALTERNATE:{if(t.subs.length===0)return this.nop();{let e=null;for(let s of t.subs){let n=this.compile(s);e=e===null?n:this.alt(e,n)}return e}}default:throw new j("regexp: unhandled case in compile")}}},J=class i{static simplify(t){if(t===null)return null;switch(t.op){case c.Op.CAPTURE:case c.Op.CONCAT:case c.Op.ALTERNATE:{let e=t;for(let s=0;s<t.subs.length;s++){let n=t.subs[s],r=i.simplify(n);e===t&&r!==n&&(e=c.fromRegexp(t),e.runes=[],e.subs=t.subs.slice(0,t.subs.length)),e!==t&&(e.subs[s]=r)}return e}case c.Op.STAR:case c.Op.PLUS:case c.Op.QUEST:{let e=i.simplify(t.subs[0]);return i.simplify1(t.op,t.flags,e,t)}case c.Op.REPEAT:{if(t.min===0&&t.max===0)return new c(c.Op.EMPTY_MATCH);let e=i.simplify(t.subs[0]);if(t.max===-1){if(t.min===0)return i.simplify1(c.Op.STAR,t.flags,e,null);if(t.min===1)return i.simplify1(c.Op.PLUS,t.flags,e,null);let n=new c(c.Op.CONCAT),r=[];for(let a=0;a<t.min-1;a++)r.push(e);return r.push(i.simplify1(c.Op.PLUS,t.flags,e,null)),n.subs=r.slice(0),n}if(t.min===1&&t.max===1)return e;let s=null;if(t.min>0){s=[];for(let n=0;n<t.min;n++)s.push(e)}if(t.max>t.min){let n=i.simplify1(c.Op.QUEST,t.flags,e,null);for(let r=t.min+1;r<t.max;r++){let a=new c(c.Op.CONCAT);a.subs=[e,n],n=i.simplify1(c.Op.QUEST,t.flags,a,null)}if(s===null)return n;s.push(n)}if(s!==null){let n=new c(c.Op.CONCAT);return n.subs=s.slice(0),n}return new c(c.Op.NO_MATCH)}}return t}static simplify1(t,e,s,n){return s.op===c.Op.EMPTY_MATCH||t===s.op&&(e&g.NON_GREEDY)===(s.flags&g.NON_GREEDY)?s:(n!==null&&n.op===t&&(n.flags&g.NON_GREEDY)===(e&g.NON_GREEDY)&&s===n.subs[0]||(n=new c(t),n.flags=e,n.subs=[s]),n)}},d=class{constructor(t,e){this.sign=t,this.cls=e}},a1=[48,57],l1=[9,10,12,13,32,32],o1=[48,57,65,90,95,95,97,122],h1=new Map([["\\d",new d(1,a1)],["\\D",new d(-1,a1)],["\\s",new d(1,l1)],["\\S",new d(-1,l1)],["\\w",new d(1,o1)],["\\W",new d(-1,o1)]]),u1=[48,57,65,90,97,122],c1=[65,90,97,122],p1=[0,127],f1=[9,9,32,32],g1=[0,31,127,127],A1=[48,57],w1=[33,126],E1=[97,122],d1=[32,126],C1=[33,47,58,64,91,96,123,126],O1=[9,13,32,32],m1=[65,90],S1=[48,57,65,90,95,95,97,122],R1=[48,57,65,70,97,102],T1=new Map([["[:alnum:]",new d(1,u1)],["[:^alnum:]",new d(-1,u1)],["[:alpha:]",new d(1,c1)],["[:^alpha:]",new d(-1,c1)],["[:ascii:]",new d(1,p1)],["[:^ascii:]",new d(-1,p1)],["[:blank:]",new d(1,f1)],["[:^blank:]",new d(-1,f1)],["[:cntrl:]",new d(1,g1)],["[:^cntrl:]",new d(-1,g1)],["[:digit:]",new d(1,A1)],["[:^digit:]",new d(-1,A1)],["[:graph:]",new d(1,w1)],["[:^graph:]",new d(-1,w1)],["[:lower:]",new d(1,E1)],["[:^lower:]",new d(-1,E1)],["[:print:]",new d(1,d1)],["[:^print:]",new d(-1,d1)],["[:punct:]",new d(1,C1)],["[:^punct:]",new d(-1,C1)],["[:space:]",new d(1,O1)],["[:^space:]",new d(-1,O1)],["[:upper:]",new d(1,m1)],["[:^upper:]",new d(-1,m1)],["[:word:]",new d(1,S1)],["[:^word:]",new d(-1,S1)],["[:xdigit:]",new d(1,R1)],["[:^xdigit:]",new d(-1,R1)]]),x=class i{static charClassToString(t,e){let s="[";for(let n=0;n<e;n+=2){n>0&&(s+=" ");let r=t[n],a=t[n+1];r===a?s+=`0x${r.toString(16)}`:s+=`0x${r.toString(16)}-0x${a.toString(16)}`}return s+="]",s}static cmp(t,e,s,n){let r=t[e]-s;return r!==0?r:n-t[e+1]}static qsortIntPair(t,e,s){let n=((e+s)/2|0)&-2,r=t[n],a=t[n+1],o=e,h=s;for(;o<=h;){for(;o<s&&i.cmp(t,o,r,a)<0;)o+=2;for(;h>e&&i.cmp(t,h,r,a)>0;)h-=2;if(o<=h){if(o!==h){let p=t[o];t[o]=t[h],t[h]=p,p=t[o+1],t[o+1]=t[h+1],t[h+1]=p}o+=2,h-=2}}e<h&&i.qsortIntPair(t,e,h),o<s&&i.qsortIntPair(t,o,s)}constructor(t=C.emptyInts()){this.r=t,this.len=t.length}toArray(){return this.len===this.r.length?this.r:this.r.slice(0,this.len)}cleanClass(){if(this.len<4)return this;i.qsortIntPair(this.r,0,this.len-2);let t=2;for(let e=2;e<this.len;e+=2){let s=this.r[e],n=this.r[e+1];if(s<=this.r[t-1]+1){n>this.r[t-1]&&(this.r[t-1]=n);continue}this.r[t]=s,this.r[t+1]=n,t+=2}return this.len=t,this}appendLiteral(t,e){return(e&g.FOLD_CASE)!==0?this.appendFoldedRange(t,t):this.appendRange(t,t)}appendRange(t,e){if(this.len>0){for(let s=2;s<=4;s+=2)if(this.len>=s){let n=this.r[this.len-s],r=this.r[this.len-s+1];if(t<=r+1&&n<=e+1)return t<n&&(this.r[this.len-s]=t),e>r&&(this.r[this.len-s+1]=e),this}}return this.r[this.len++]=t,this.r[this.len++]=e,this}appendFoldedRange(t,e){if(t<=w.MIN_FOLD&&e>=w.MAX_FOLD)return this.appendRange(t,e);if(e<w.MIN_FOLD||t>w.MAX_FOLD)return this.appendRange(t,e);t<w.MIN_FOLD&&(this.appendRange(t,w.MIN_FOLD-1),t=w.MIN_FOLD),e>w.MAX_FOLD&&(this.appendRange(w.MAX_FOLD+1,e),e=w.MAX_FOLD);for(let s=t;s<=e;s++){this.appendRange(s,s);for(let n=w.simpleFold(s);n!==s;n=w.simpleFold(n))this.appendRange(n,n)}return this}appendClass(t){for(let e=0;e<t.length;e+=2)this.appendRange(t[e],t[e+1]);return this}appendFoldedClass(t){for(let e=0;e<t.length;e+=2)this.appendFoldedRange(t[e],t[e+1]);return this}appendNegatedClass(t){let e=0;for(let s=0;s<t.length;s+=2){let n=t[s],r=t[s+1];e<=n-1&&this.appendRange(e,n-1),e=r+1}return e<=w.MAX_RUNE&&this.appendRange(e,w.MAX_RUNE),this}appendTable(t){for(let e=0;e<t.length;++e){let s=t.getLo(e),n=t.getHi(e),r=t.getStride(e);if(r===1){this.appendRange(s,n);continue}for(let a=s;a<=n;a+=r)this.appendRange(a,a)}return this}appendNegatedTable(t){let e=0;for(let s=0;s<t.length;++s){let n=t.getLo(s),r=t.getHi(s),a=t.getStride(s);if(a===1){e<=n-1&&this.appendRange(e,n-1),e=r+1;continue}for(let o=n;o<=r;o+=a)e<=o-1&&this.appendRange(e,o-1),e=o+1}return e<=w.MAX_RUNE&&this.appendRange(e,w.MAX_RUNE),this}appendTableWithSign(t,e){return e<0?this.appendNegatedTable(t):this.appendTable(t)}negateClass(){let t=0,e=0;for(let s=0;s<this.len;s+=2){let n=this.r[s],r=this.r[s+1];t<=n-1&&(this.r[e]=t,this.r[e+1]=n-1,e+=2),t=r+1}return this.len=e,t<=w.MAX_RUNE&&(this.r[this.len++]=t,this.r[this.len++]=w.MAX_RUNE),this}appendClassWithSign(t,e){return e<0?this.appendNegatedClass(t):this.appendClass(t)}appendGroup(t,e){let s=t.cls;return e&&(s=new i().appendFoldedClass(s).cleanClass().toArray()),this.appendClassWithSign(s,t.sign)}toString(){return i.charClassToString(this.r,this.len)}},H=class i{static of(t,e){return new i(t,e)}constructor(t,e){this.first=t,this.second=e}},t1=class{constructor(t){this.str=t,this.position=0}pos(){return this.position}rewindTo(t){this.position=t}more(){return this.position<this.str.length}peek(){return this.str.codePointAt(this.position)}skip(t){this.position+=t}skipString(t){this.position+=t.length}pop(){let t=this.str.codePointAt(this.position);return this.position+=C.charCount(t),t}lookingAt(t){return this.rest().startsWith(t)}rest(){return this.str.substring(this.position)}from(t){return this.str.substring(t,this.position)}toString(){return this.rest()}},e1=class i{static ERR_INTERNAL_ERROR="regexp/syntax: internal error";static ERR_INVALID_CHAR_RANGE="invalid character class range";static ERR_INVALID_ESCAPE="invalid escape sequence";static ERR_INVALID_NAMED_CAPTURE="invalid named capture";static ERR_INVALID_PERL_OP="invalid or unsupported Perl syntax";static ERR_INVALID_REPEAT_OP="invalid nested repetition operator";static ERR_INVALID_REPEAT_SIZE="invalid repeat count";static ERR_MISSING_BRACKET="missing closing ]";static ERR_MISSING_PAREN="missing closing )";static ERR_MISSING_REPEAT_ARGUMENT="missing argument to repetition operator";static ERR_TRAILING_BACKSLASH="trailing backslash at end of expression";static ERR_DUPLICATE_NAMED_CAPTURE="duplicate capture group name";static ERR_UNEXPECTED_PAREN="unexpected )";static ERR_NESTING_DEPTH="expression nests too deeply";static ERR_LARGE="expression too large";static MAX_HEIGHT=1e3;static MAX_SIZE=3355443;static MAX_RUNES=33554432;static ANY_TABLE=new l(new Uint32Array([0,w.MAX_RUNE,1]));static unicodeTable(t){return t==="Any"?H.of(i.ANY_TABLE,i.ANY_TABLE):b.CATEGORIES.has(t)?H.of(b.CATEGORIES.get(t),b.FOLD_CATEGORIES.get(t)):b.SCRIPTS.has(t)?H.of(b.SCRIPTS.get(t),b.FOLD_SCRIPT.get(t)):null}static minFoldRune(t){if(t<w.MIN_FOLD||t>w.MAX_FOLD)return t;let e=t,s=t;for(t=w.simpleFold(t);t!==s;t=w.simpleFold(t))e>t&&(e=t);return e}static leadingRegexp(t){if(t.op===c.Op.EMPTY_MATCH)return null;if(t.op===c.Op.CONCAT&&t.subs.length>0){let e=t.subs[0];return e.op===c.Op.EMPTY_MATCH?null:e}return t}static literalRegexp(t,e){let s=new c(c.Op.LITERAL);return s.flags=e,s.runes=C.stringToRunes(t),s}static parse(t,e){return new i(t,e).parseInternal()}static parseRepeat(t){let e=t.pos();if(!t.more()||!t.lookingAt("{"))return-1;t.skip(1);let s=i.parseInt(t);if(s===-1||!t.more())return-1;let n;if(!t.lookingAt(","))n=s;else{if(t.skip(1),!t.more())return-1;if(t.lookingAt("}"))n=-1;else if((n=i.parseInt(t))===-1)return-1}if(!t.more()||!t.lookingAt("}"))return-1;if(t.skip(1),s<0||s>1e3||n===-2||n>1e3||n>=0&&s>n)throw new m(i.ERR_INVALID_REPEAT_SIZE,t.from(e));return s<<16|n&w.MAX_BMP}static isValidCaptureName(t){if(t.length===0)return!1;for(let e=0;e<t.length;e++){let s=t.codePointAt(e);if(s!==u.CODES.get("_")&&!C.isalnum(s))return!1}return!0}static parseInt(t){let e=t.pos();for(;t.more()&&t.peek()>=u.CODES.get("0")&&t.peek()<=u.CODES.get("9");)t.skip(1);let s=t.from(e);return s.length===0||s.length>1&&s.codePointAt(0)===u.CODES.get("0")?-1:s.length>8?-2:parseFloat(s,10)}static isCharClass(t){return t.op===c.Op.LITERAL&&t.runes.length===1||t.op===c.Op.CHAR_CLASS||t.op===c.Op.ANY_CHAR_NOT_NL||t.op===c.Op.ANY_CHAR}static matchRune(t,e){switch(t.op){case c.Op.LITERAL:return t.runes.length===1&&t.runes[0]===e;case c.Op.CHAR_CLASS:for(let s=0;s<t.runes.length;s+=2)if(t.runes[s]<=e&&e<=t.runes[s+1])return!0;return!1;case c.Op.ANY_CHAR_NOT_NL:return e!==u.CODES.get(`
`);case c.Op.ANY_CHAR:return!0}return!1}static mergeCharClass(t,e){switch(t.op){case c.Op.ANY_CHAR:break;case c.Op.ANY_CHAR_NOT_NL:i.matchRune(e,u.CODES.get(`
`))&&(t.op=c.Op.ANY_CHAR);break;case c.Op.CHAR_CLASS:e.op===c.Op.LITERAL?t.runes=new x(t.runes).appendLiteral(e.runes[0],e.flags).toArray():t.runes=new x(t.runes).appendClass(e.runes).toArray();break;case c.Op.LITERAL:if(e.runes[0]===t.runes[0]&&e.flags===t.flags)break;t.op=c.Op.CHAR_CLASS,t.runes=new x().appendLiteral(t.runes[0],t.flags).appendLiteral(e.runes[0],e.flags).toArray();break}}static parseEscape(t){let e=t.pos();if(t.skip(1),!t.more())throw new m(i.ERR_TRAILING_BACKSLASH);let s=t.pop();t:switch(s){case u.CODES.get("1"):case u.CODES.get("2"):case u.CODES.get("3"):case u.CODES.get("4"):case u.CODES.get("5"):case u.CODES.get("6"):case u.CODES.get("7"):if(!t.more()||t.peek()<u.CODES.get("0")||t.peek()>u.CODES.get("7"))break;case u.CODES.get("0"):{let n=s-u.CODES.get("0");for(let r=1;r<3&&!(!t.more()||t.peek()<u.CODES.get("0")||t.peek()>u.CODES.get("7"));r++)n=n*8+t.peek()-u.CODES.get("0"),t.skip(1);return n}case u.CODES.get("x"):{if(!t.more())break;if(s=t.pop(),s===u.CODES.get("{")){let a=0,o=0;for(;;){if(!t.more())break t;if(s=t.pop(),s===u.CODES.get("}"))break;let h=C.unhex(s);if(h<0||(o=o*16+h,o>w.MAX_RUNE))break t;a++}if(a===0)break t;return o}let n=C.unhex(s);if(!t.more())break;s=t.pop();let r=C.unhex(s);if(n<0||r<0)break;return n*16+r}case u.CODES.get("a"):return u.CODES.get("\x07");case u.CODES.get("f"):return u.CODES.get("\f");case u.CODES.get("n"):return u.CODES.get(`
`);case u.CODES.get("r"):return u.CODES.get("\r");case u.CODES.get("t"):return u.CODES.get("	");case u.CODES.get("v"):return u.CODES.get("\v");default:if(s<=w.MAX_ASCII&&!C.isalnum(s))return s;break}throw new m(i.ERR_INVALID_ESCAPE,t.from(e))}static parseClassChar(t,e){if(!t.more())throw new m(i.ERR_MISSING_BRACKET,t.from(e));return t.lookingAt("\\")?i.parseEscape(t):t.pop()}static concatRunes(t,e){return[...t,...e]}constructor(t,e=0){this.wholeRegexp=t,this.flags=e,this.numCap=0,this.namedGroups={},this.stack=[],this.free=null,this.numRegexp=0,this.numRunes=0,this.repeats=0,this.height=null,this.size=null}newRegexp(t){let e=this.free;return e!==null&&e.subs!==null&&e.subs.length>0?(this.free=e.subs[0],e.reinit(),e.op=t):(e=new c(t),this.numRegexp+=1),e}reuse(t){this.height!==null&&Object.prototype.hasOwnProperty.call(this.height,t)&&delete this.height[t],t.subs!==null&&t.subs.length>0&&(t.subs[0]=this.free),this.free=t}checkLimits(t){if(this.numRunes>i.MAX_RUNES)throw new m(i.ERR_LARGE);this.checkSize(t),this.checkHeight(t)}checkSize(t){if(this.size===null){if(this.repeats===0&&(this.repeats=1),t.op===c.Op.REPEAT){let e=t.max;e===-1&&(e=t.min),e<=0&&(e=1),e>i.MAX_SIZE/this.repeats?this.repeats=i.MAX_SIZE:this.repeats*=e}if(this.numRegexp<i.MAX_SIZE/this.repeats)return;this.size={};for(let e of this.stack)this.checkSize(e)}if(this.calcSize(t,!0)>i.MAX_SIZE)throw new m(i.ERR_LARGE)}calcSize(t,e=!1){if(!e&&Object.prototype.hasOwnProperty.call(this.size,t))return this.size[t];let s=0;switch(t.op){case c.Op.LITERAL:{s=t.runes.length;break}case c.Op.CAPTURE:case c.Op.STAR:{s=2+this.calcSize(t.subs[0]);break}case c.Op.PLUS:case c.Op.QUEST:{s=1+this.calcSize(t.subs[0]);break}case c.Op.CONCAT:{for(let n of t.subs)s=s+this.calcSize(n);break}case c.Op.ALTERNATE:{for(let n of t.subs)s=s+this.calcSize(n);t.subs.length>1&&(s=s+t.subs.length-1);break}case c.Op.REPEAT:{let n=this.calcSize(t.subs[0]);if(t.max===-1){t.min===0?s=2+n:s=1+t.min*n;break}s=t.max*n+(t.max-t.min);break}}return s=Math.max(1,s),this.size[t]=s,s}checkHeight(t){if(!(this.numRegexp<i.MAX_HEIGHT)){if(this.height===null){this.height={};for(let e of this.stack)this.checkHeight(e)}if(this.calcHeight(t,!0)>i.MAX_HEIGHT)throw new m(i.ERR_NESTING_DEPTH)}}calcHeight(t,e=!1){if(!e&&Object.prototype.hasOwnProperty.call(this.height,t))return this.height[t];let s=1;for(let n of t.subs){let r=this.calcHeight(n);s<1+r&&(s=1+r)}return this.height[t]=s,s}pop(){return this.stack.pop()}popToPseudo(){let t=this.stack.length,e=t;for(;e>0&&!c.isPseudoOp(this.stack[e-1].op);)e--;let s=this.stack.slice(e,t);return this.stack=this.stack.slice(0,e),s}push(t){if(this.numRunes+=t.runes.length,t.op===c.Op.CHAR_CLASS&&t.runes.length===2&&t.runes[0]===t.runes[1]){if(this.maybeConcat(t.runes[0],this.flags&-2))return null;t.op=c.Op.LITERAL,t.runes=[t.runes[0]],t.flags=this.flags&-2}else if(t.op===c.Op.CHAR_CLASS&&t.runes.length===4&&t.runes[0]===t.runes[1]&&t.runes[2]===t.runes[3]&&w.simpleFold(t.runes[0])===t.runes[2]&&w.simpleFold(t.runes[2])===t.runes[0]||t.op===c.Op.CHAR_CLASS&&t.runes.length===2&&t.runes[0]+1===t.runes[1]&&w.simpleFold(t.runes[0])===t.runes[1]&&w.simpleFold(t.runes[1])===t.runes[0]){if(this.maybeConcat(t.runes[0],this.flags|g.FOLD_CASE))return null;t.op=c.Op.LITERAL,t.runes=[t.runes[0]],t.flags=this.flags|g.FOLD_CASE}else this.maybeConcat(-1,0);return this.stack.push(t),this.checkLimits(t),t}maybeConcat(t,e){let s=this.stack.length;if(s<2)return!1;let n=this.stack[s-1],r=this.stack[s-2];return n.op!==c.Op.LITERAL||r.op!==c.Op.LITERAL||(n.flags&g.FOLD_CASE)!==(r.flags&g.FOLD_CASE)?!1:(r.runes=i.concatRunes(r.runes,n.runes),t>=0?(n.runes=[t],n.flags=e,!0):(this.pop(),this.reuse(n),!1))}newLiteral(t,e){let s=this.newRegexp(c.Op.LITERAL);return s.flags=e,(e&g.FOLD_CASE)!==0&&(t=i.minFoldRune(t)),s.runes=[t],s}literal(t){this.push(this.newLiteral(t,this.flags))}op(t){let e=this.newRegexp(t);return e.flags=this.flags,this.push(e)}repeat(t,e,s,n,r,a){let o=this.flags;if((o&g.PERL_X)!==0&&(r.more()&&r.lookingAt("?")&&(r.skip(1),o^=g.NON_GREEDY),a!==-1))throw new m(i.ERR_INVALID_REPEAT_OP,r.from(a));let h=this.stack.length;if(h===0)throw new m(i.ERR_MISSING_REPEAT_ARGUMENT,r.from(n));let p=this.stack[h-1];if(c.isPseudoOp(p.op))throw new m(i.ERR_MISSING_REPEAT_ARGUMENT,r.from(n));let f=this.newRegexp(t);if(f.min=e,f.max=s,f.flags=o,f.subs=[p],this.stack[h-1]=f,this.checkLimits(f),t===c.Op.REPEAT&&(e>=2||s>=2)&&!this.repeatIsValid(f,1e3))throw new m(i.ERR_INVALID_REPEAT_SIZE,r.from(n))}repeatIsValid(t,e){if(t.op===c.Op.REPEAT){let s=t.max;if(s===0)return!0;if(s<0&&(s=t.min),s>e)return!1;s>0&&(e=Math.trunc(e/s))}for(let s of t.subs)if(!this.repeatIsValid(s,e))return!1;return!0}concat(){this.maybeConcat(-1,0);let t=this.popToPseudo();return t.length===0?this.push(this.newRegexp(c.Op.EMPTY_MATCH)):this.push(this.collapse(t,c.Op.CONCAT))}alternate(){let t=this.popToPseudo();return t.length>0&&this.cleanAlt(t[t.length-1]),t.length===0?this.push(this.newRegexp(c.Op.NO_MATCH)):this.push(this.collapse(t,c.Op.ALTERNATE))}cleanAlt(t){t.op===c.Op.CHAR_CLASS&&(t.runes=new x(t.runes).cleanClass().toArray(),t.runes.length===2&&t.runes[0]===0&&t.runes[1]===w.MAX_RUNE?(t.runes=[],t.op=c.Op.ANY_CHAR):t.runes.length===4&&t.runes[0]===0&&t.runes[1]===u.CODES.get(`
`)-1&&t.runes[2]===u.CODES.get(`
`)+1&&t.runes[3]===w.MAX_RUNE&&(t.runes=[],t.op=c.Op.ANY_CHAR_NOT_NL))}collapse(t,e){if(t.length===1)return t[0];let s=0;for(let o of t)s+=o.op===e?o.subs.length:1;let n=new Array(s).fill(null),r=0;for(let o of t)o.op===e?(n.splice(r,o.subs.length,...o.subs),r+=o.subs.length,this.reuse(o)):n[r++]=o;let a=this.newRegexp(e);if(a.subs=n,e===c.Op.ALTERNATE&&(a.subs=this.factor(a.subs),a.subs.length===1)){let o=a;a=a.subs[0],this.reuse(o)}return a}factor(t){if(t.length<2)return t;let e=0,s=t.length,n=0,r=null,a=0,o=0,h=0;for(let f=0;f<=s;f++){let A=null,N=0,O=0;if(f<s){let S=t[e+f];if(S.op===c.Op.CONCAT&&S.subs.length>0&&(S=S.subs[0]),S.op===c.Op.LITERAL&&(A=S.runes,N=S.runes.length,O=S.flags&g.FOLD_CASE),O===o){let T=0;for(;T<a&&T<N&&r[T]===A[T];)T++;if(T>0){a=T;continue}}}if(f!==h)if(f===h+1)t[n++]=t[e+h];else{let S=this.newRegexp(c.Op.LITERAL);S.flags=o,S.runes=r.slice(0,a);for(let k=h;k<f;k++)t[e+k]=this.removeLeadingString(t[e+k],a),this.checkLimits(t[e+k]);let T=this.collapse(t.slice(e+h,e+f),c.Op.ALTERNATE),G=this.newRegexp(c.Op.CONCAT);G.subs=[S,T],t[n++]=G}h=f,r=A,a=N,o=O}s=n,e=0,h=0,n=0;let p=null;for(let f=0;f<=s;f++){let A=null;if(!(f<s&&(A=i.leadingRegexp(t[e+f]),p!==null&&p.equals(A)&&(i.isCharClass(p)||p.op===c.Op.REPEAT&&p.min===p.max&&i.isCharClass(p.subs[0]))))){if(f!==h)if(f===h+1)t[n++]=t[e+h];else{let N=p;for(let T=h;T<f;T++){let G=T!==h;t[e+T]=this.removeLeadingRegexp(t[e+T],G),this.checkLimits(t[e+T])}let O=this.collapse(t.slice(e+h,e+f),c.Op.ALTERNATE),S=this.newRegexp(c.Op.CONCAT);S.subs=[N,O],t[n++]=S}h=f,p=A}}s=n,e=0,h=0,n=0;for(let f=0;f<=s;f++)if(!(f<s&&i.isCharClass(t[e+f]))){if(f!==h)if(f===h+1)t[n++]=t[e+h];else{let A=h;for(let O=h+1;O<f;O++){let S=t[e+A],T=t[e+O];(S.op<T.op||S.op===T.op&&(S.runes!==null?S.runes.length:0)<(T.runes!==null?T.runes.length:0))&&(A=O)}let N=t[e+h];t[e+h]=t[e+A],t[e+A]=N;for(let O=h+1;O<f;O++)i.mergeCharClass(t[e+h],t[e+O]),this.reuse(t[e+O]);this.cleanAlt(t[e+h]),t[n++]=t[e+h]}f<s&&(t[n++]=t[e+f]),h=f+1}s=n,e=0,h=0,n=0;for(let f=0;f<s;++f)f+1<s&&t[e+f].op===c.Op.EMPTY_MATCH&&t[e+f+1].op===c.Op.EMPTY_MATCH||(t[n++]=t[e+f]);return s=n,e=0,t.slice(e,s)}removeLeadingString(t,e){if(t.op===c.Op.CONCAT&&t.subs.length>0){let s=this.removeLeadingString(t.subs[0],e);if(t.subs[0]=s,s.op===c.Op.EMPTY_MATCH)switch(this.reuse(s),t.subs.length){case 0:case 1:t.op=c.Op.EMPTY_MATCH,t.subs=null;break;case 2:{let n=t;t=t.subs[1],this.reuse(n);break}default:t.subs=t.subs.slice(1,t.subs.length);break}return t}return t.op===c.Op.LITERAL&&(t.runes=t.runes.slice(e,t.runes.length),t.runes.length===0&&(t.op=c.Op.EMPTY_MATCH)),t}removeLeadingRegexp(t,e){if(t.op===c.Op.CONCAT&&t.subs.length>0){switch(e&&this.reuse(t.subs[0]),t.subs=t.subs.slice(1,t.subs.length),t.subs.length){case 0:{t.op=c.Op.EMPTY_MATCH,t.subs=c.emptySubs();break}case 1:{let s=t;t=t.subs[0],this.reuse(s);break}}return t}return e&&this.reuse(t),this.newRegexp(c.Op.EMPTY_MATCH)}parseInternal(){if((this.flags&g.LITERAL)!==0)return i.literalRegexp(this.wholeRegexp,this.flags);let t=-1,e=-1,s=-1,n=new t1(this.wholeRegexp);for(;n.more();){let a=-1;t:switch(n.peek()){case u.CODES.get("("):if((this.flags&g.PERL_X)!==0&&n.lookingAt("(?")){this.parsePerlFlags(n);break}this.op(c.Op.LEFT_PAREN).cap=++this.numCap,n.skip(1);break;case u.CODES.get("|"):this.parseVerticalBar(),n.skip(1);break;case u.CODES.get(")"):this.parseRightParen(),n.skip(1);break;case u.CODES.get("^"):(this.flags&g.ONE_LINE)!==0?this.op(c.Op.BEGIN_TEXT):this.op(c.Op.BEGIN_LINE),n.skip(1);break;case u.CODES.get("$"):(this.flags&g.ONE_LINE)!==0?this.op(c.Op.END_TEXT).flags|=g.WAS_DOLLAR:this.op(c.Op.END_LINE),n.skip(1);break;case u.CODES.get("."):(this.flags&g.DOT_NL)!==0?this.op(c.Op.ANY_CHAR):this.op(c.Op.ANY_CHAR_NOT_NL),n.skip(1);break;case u.CODES.get("["):this.parseClass(n);break;case u.CODES.get("*"):case u.CODES.get("+"):case u.CODES.get("?"):{a=n.pos();let o=null;switch(n.pop()){case u.CODES.get("*"):o=c.Op.STAR;break;case u.CODES.get("+"):o=c.Op.PLUS;break;case u.CODES.get("?"):o=c.Op.QUEST;break}this.repeat(o,e,s,a,n,t);break}case u.CODES.get("{"):{a=n.pos();let o=i.parseRepeat(n);if(o<0){n.rewindTo(a),this.literal(n.pop());break}e=o>>16,s=(o&w.MAX_BMP)<<16>>16,this.repeat(c.Op.REPEAT,e,s,a,n,t);break}case u.CODES.get("\\"):{let o=n.pos();if(n.skip(1),(this.flags&g.PERL_X)!==0&&n.more())switch(n.pop()){case u.CODES.get("A"):this.op(c.Op.BEGIN_TEXT);break t;case u.CODES.get("b"):this.op(c.Op.WORD_BOUNDARY);break t;case u.CODES.get("B"):this.op(c.Op.NO_WORD_BOUNDARY);break t;case u.CODES.get("C"):throw new m(i.ERR_INVALID_ESCAPE,"\\C");case u.CODES.get("Q"):{let A=n.rest(),N=A.indexOf("\\E");N>=0&&(A=A.substring(0,N)),n.skipString(A),n.skipString("\\E");let O=0;for(;O<A.length;){let S=A.codePointAt(O);this.literal(S),O+=C.charCount(S)}break t}case u.CODES.get("z"):this.op(c.Op.END_TEXT);break t;default:n.rewindTo(o);break}let h=this.newRegexp(c.Op.CHAR_CLASS);if(h.flags=this.flags,n.lookingAt("\\p")||n.lookingAt("\\P")){let f=new x;if(this.parseUnicodeClass(n,f)){h.runes=f.toArray(),this.push(h);break t}}let p=new x;if(this.parsePerlClassEscape(n,p)){h.runes=p.toArray(),this.push(h);break t}n.rewindTo(o),this.reuse(h),this.literal(i.parseEscape(n));break}default:this.literal(n.pop());break}t=a}if(this.concat(),this.swapVerticalBar()&&this.pop(),this.alternate(),this.stack.length!==1)throw new m(i.ERR_MISSING_PAREN,this.wholeRegexp);return this.stack[0].namedGroups=this.namedGroups,this.stack[0]}parsePerlFlags(t){let e=t.pos(),s=t.rest();if(s.startsWith("(?P<")||s.startsWith("(?<")){let o=s.charAt(2)==="P"?4:3,h=s.indexOf(">");if(h<0)throw new m(i.ERR_INVALID_NAMED_CAPTURE,s);let p=s.substring(o,h);if(t.skipString(p),t.skip(o+1),!i.isValidCaptureName(p))throw new m(i.ERR_INVALID_NAMED_CAPTURE,s.substring(0,h+1));let f=this.op(c.Op.LEFT_PAREN);if(f.cap=++this.numCap,this.namedGroups[p])throw new m(i.ERR_DUPLICATE_NAMED_CAPTURE,p);this.namedGroups[p]=this.numCap,f.name=p;return}t.skip(2);let n=this.flags,r=1,a=!1;t:for(;t.more();){let o=t.pop();switch(o){case u.CODES.get("i"):n|=g.FOLD_CASE,a=!0;break;case u.CODES.get("m"):n&=-17,a=!0;break;case u.CODES.get("s"):n|=g.DOT_NL,a=!0;break;case u.CODES.get("U"):n|=g.NON_GREEDY,a=!0;break;case u.CODES.get("-"):if(r<0)break t;r=-1,n=~n,a=!1;break;case u.CODES.get(":"):case u.CODES.get(")"):if(r<0){if(!a)break t;n=~n}o===u.CODES.get(":")&&this.op(c.Op.LEFT_PAREN),this.flags=n;return;default:break t}}throw new m(i.ERR_INVALID_PERL_OP,t.from(e))}parseVerticalBar(){this.concat(),this.swapVerticalBar()||this.op(c.Op.VERTICAL_BAR)}swapVerticalBar(){let t=this.stack.length;if(t>=3&&this.stack[t-2].op===c.Op.VERTICAL_BAR&&i.isCharClass(this.stack[t-1])&&i.isCharClass(this.stack[t-3])){let e=this.stack[t-1],s=this.stack[t-3];if(e.op>s.op){let n=s;s=e,e=n,this.stack[t-3]=s}return i.mergeCharClass(s,e),this.reuse(e),this.pop(),!0}if(t>=2){let e=this.stack[t-1],s=this.stack[t-2];if(s.op===c.Op.VERTICAL_BAR)return t>=3&&this.cleanAlt(this.stack[t-3]),this.stack[t-2]=e,this.stack[t-1]=s,!0}return!1}parseRightParen(){if(this.concat(),this.swapVerticalBar()&&this.pop(),this.alternate(),this.stack.length<2)throw new m(i.ERR_UNEXPECTED_PAREN,this.wholeRegexp);let e=this.pop(),s=this.pop();if(s.op!==c.Op.LEFT_PAREN)throw new m(i.ERR_UNEXPECTED_PAREN,this.wholeRegexp);this.flags=s.flags,s.cap===0?this.push(e):(s.op=c.Op.CAPTURE,s.subs=[e],this.push(s))}parsePerlClassEscape(t,e){let s=t.pos();if((this.flags&g.PERL_X)===0||!t.more()||t.pop()!==u.CODES.get("\\")||!t.more())return!1;t.pop();let n=t.from(s),r=h1.has(n)?h1.get(n):null;return r===null?!1:(e.appendGroup(r,(this.flags&g.FOLD_CASE)!==0),!0)}parseNamedClass(t,e){let s=t.rest(),n=s.indexOf(":]");if(n<0)return!1;let r=s.substring(0,n+2);t.skipString(r);let a=T1.has(r)?T1.get(r):null;if(a===null)throw new m(i.ERR_INVALID_CHAR_RANGE,r);return e.appendGroup(a,(this.flags&g.FOLD_CASE)!==0),!0}parseUnicodeClass(t,e){let s=t.pos();if((this.flags&g.UNICODE_GROUPS)===0||!t.lookingAt("\\p")&&!t.lookingAt("\\P"))return!1;t.skip(1);let n=1,r=t.pop();if(r===u.CODES.get("P")&&(n=-1),!t.more())throw t.rewindTo(s),new m(i.ERR_INVALID_CHAR_RANGE,t.rest());r=t.pop();let a;if(r!==u.CODES.get("{"))a=C.runeToString(r);else{let f=t.rest(),A=f.indexOf("}");if(A<0)throw t.rewindTo(s),new m(i.ERR_INVALID_CHAR_RANGE,t.rest());a=f.substring(0,A),t.skipString(a),t.skip(1)}a.length!==0&&a.codePointAt(0)===u.CODES.get("^")&&(n=0-n,a=a.substring(1));let o=i.unicodeTable(a);if(o===null)throw new m(i.ERR_INVALID_CHAR_RANGE,t.from(s));let h=o.first,p=o.second;if((this.flags&g.FOLD_CASE)===0||p===null)e.appendTableWithSign(h,n);else{let f=new x().appendTable(h).appendTable(p).cleanClass().toArray();e.appendClassWithSign(f,n)}return!0}parseClass(t){let e=t.pos();t.skip(1);let s=this.newRegexp(c.Op.CHAR_CLASS);s.flags=this.flags;let n=new x,r=1;t.more()&&t.lookingAt("^")&&(r=-1,t.skip(1),(this.flags&g.CLASS_NL)===0&&n.appendRange(u.CODES.get(`
`),u.CODES.get(`
`)));let a=!0;for(;!t.more()||t.peek()!==u.CODES.get("]")||a;){if(t.more()&&t.lookingAt("-")&&(this.flags&g.PERL_X)===0&&!a){let f=t.rest();if(f==="-"||!f.startsWith("-]"))throw t.rewindTo(e),new m(i.ERR_INVALID_CHAR_RANGE,t.rest())}a=!1;let o=t.pos();if(t.lookingAt("[:")){if(this.parseNamedClass(t,n))continue;t.rewindTo(o)}if(this.parseUnicodeClass(t,n)||this.parsePerlClassEscape(t,n))continue;t.rewindTo(o);let h=i.parseClassChar(t,e),p=h;if(t.more()&&t.lookingAt("-")){if(t.skip(1),t.more()&&t.lookingAt("]"))t.skip(-1);else if(p=i.parseClassChar(t,e),p<h)throw new m(i.ERR_INVALID_CHAR_RANGE,t.from(o))}(this.flags&g.FOLD_CASE)===0?n.appendRange(h,p):n.appendFoldedRange(h,p)}t.skip(1),n.cleanClass(),r<0&&n.negateClass(),s.runes=n.toArray(),this.push(s)}},s1=class{constructor(t){this.value=t}get(){return this.value}set(t){this.value=t}compareAndSet(t,e){return this.value===t?(this.value=e,!0):!1}},n1=class i{static initTest(t){let e=i.compile(t),s=new i(e.expr,e.prog,e.numSubexp,e.longest);return s.cond=e.cond,s.prefix=e.prefix,s.prefixUTF8=e.prefixUTF8,s.prefixComplete=e.prefixComplete,s.prefixRune=e.prefixRune,s}static compile(t){return i.compileImpl(t,g.PERL,!1)}static compilePOSIX(t){return i.compileImpl(t,g.POSIX,!0)}static compileImpl(t,e,s){let n=e1.parse(t,e),r=n.maxCap();n=J.simplify(n);let a=Q.compileRegexp(n),o=new i(t,a,r,s),[h,p]=a.prefix();return o.prefixComplete=h,o.prefix=p,o.prefixUTF8=C.stringToUtf8ByteArray(o.prefix),o.prefix.length>0&&(o.prefixRune=o.prefix.codePointAt(0)),o.namedGroups=n.namedGroups,o}static match(t,e){return i.compile(t).match(e)}constructor(t,e,s=0,n=0){this.expr=t,this.prog=e,this.numSubexp=s,this.longest=n,this.cond=e.startCond(),this.prefix=null,this.prefixUTF8=null,this.prefixComplete=!1,this.prefixRune=0,this.pooled=new s1,this.dfa=new K(e)}executeEngine(t,e,s,n){if(n>0)return this.doExecuteNFA(t,e,s,n);let r=this.dfa.match(t,e,s);return r!==null?r?[]:null:this.doExecuteNFA(t,e,s,n)}numberOfCapturingGroups(){return this.numSubexp}numberOfInstructions(){return this.prog.numInst()}get(){let t;do t=this.pooled.get();while(t&&!this.pooled.compareAndSet(t,t.next));return t}reset(){this.pooled.set(null)}put(t,e){let s=this.pooled.get();do s=this.pooled.get(),!e&&s&&(t=M.fromMachine(t),e=!0),t.next!==s&&(t.next=s);while(!this.pooled.compareAndSet(s,t))}toString(){return this.expr}doExecuteNFA(t,e,s,n){let r=this.get(),a=!1;r?r.next!==null&&(r=M.fromMachine(r),a=!0):(r=M.fromRE2(this),a=!0),r.init(n);let o=r.match(t,e,s)?r.submatches():null;return this.put(r,a),o}match(t){return this.executeEngine(R.fromUTF16(t),0,g.UNANCHORED,0)!==null}matchWithGroup(t,e,s,n,r){return t instanceof I||(t=_.utf16(t)),this.matchMachineInput(t,e,s,n,r)}matchMachineInput(t,e,s,n,r){if(e>s)return[!1,null];let a=t.isUTF16Encoding()?R.fromUTF16(t.asCharSequence(),0,s):R.fromUTF8(t.asBytes(),0,s),o=this.executeEngine(a,e,n,2*r);return o===null?[!1,null]:[!0,o]}matchUTF8(t){return this.executeEngine(R.fromUTF8(t),0,g.UNANCHORED,0)!==null}replaceAll(t,e){return this.replaceAllFunc(t,()=>e,2*t.length+1)}replaceFirst(t,e){return this.replaceAllFunc(t,()=>e,1)}replaceAllFunc(t,e,s){let n=0,r=0,a="",o=R.fromUTF16(t),h=0;for(;r<=t.length;){let p=this.executeEngine(o,r,g.UNANCHORED,2);if(p===null||p.length===0)break;a+=t.substring(n,p[0]),(p[1]>n||p[0]===0)&&(a+=e(t.substring(p[0],p[1])),h++),n=p[1];let f=o.step(r)&7;if(r+f>p[1]?r+=f:r+1>p[1]?r++:r=p[1],h>=s)break}return a+=t.substring(n),a}pad(t){if(t===null)return null;let e=(1+this.numSubexp)*2;if(t.length<e){let s=new Array(e).fill(-1);for(let n=0;n<t.length;n++)s[n]=t[n];t=s}return t}allMatches(t,e,s=n=>n){let n=[],r=t.endPos();e<0&&(e=r+1);let a=0,o=0,h=-1;for(;o<e&&a<=r;){let p=this.executeEngine(t,a,g.UNANCHORED,this.prog.numCap);if(p===null||p.length===0)break;let f=!0;if(p[1]===a){p[0]===h&&(f=!1);let A=t.step(a);A<0?a=r+1:a+=A&7}else a=p[1];h=p[1],f&&(n.push(s(this.pad(p))),o++)}return n}findUTF8(t){let e=this.executeEngine(R.fromUTF8(t),0,g.UNANCHORED,2);return e===null?null:t.slice(e[0],e[1])}findUTF8Index(t){let e=this.executeEngine(R.fromUTF8(t),0,g.UNANCHORED,2);return e===null?null:e.slice(0,2)}find(t){let e=this.executeEngine(R.fromUTF16(t),0,g.UNANCHORED,2);return e===null?"":t.substring(e[0],e[1])}findIndex(t){return this.executeEngine(R.fromUTF16(t),0,g.UNANCHORED,2)}findUTF8Submatch(t){let e=this.executeEngine(R.fromUTF8(t),0,g.UNANCHORED,this.prog.numCap);if(e===null)return null;let s=new Array(1+this.numSubexp).fill(null);for(let n=0;n<s.length;n++)2*n<e.length&&e[2*n]>=0&&(s[n]=t.slice(e[2*n],e[2*n+1]));return s}findUTF8SubmatchIndex(t){return this.pad(this.executeEngine(R.fromUTF8(t),0,g.UNANCHORED,this.prog.numCap))}findSubmatch(t){let e=this.executeEngine(R.fromUTF16(t),0,g.UNANCHORED,this.prog.numCap);if(e===null)return null;let s=new Array(1+this.numSubexp).fill(null);for(let n=0;n<s.length;n++)2*n<e.length&&e[2*n]>=0&&(s[n]=t.substring(e[2*n],e[2*n+1]));return s}findSubmatchIndex(t){return this.pad(this.executeEngine(R.fromUTF16(t),0,g.UNANCHORED,this.prog.numCap))}findAllUTF8(t,e){let s=this.allMatches(R.fromUTF8(t),e,n=>t.slice(n[0],n[1]));return s.length===0?null:s}findAllUTF8Index(t,e){let s=this.allMatches(R.fromUTF8(t),e,n=>n.slice(0,2));return s.length===0?null:s}findAll(t,e){let s=this.allMatches(R.fromUTF16(t),e,n=>t.substring(n[0],n[1]));return s.length===0?null:s}findAllIndex(t,e){let s=this.allMatches(R.fromUTF16(t),e,n=>n.slice(0,2));return s.length===0?null:s}findAllUTF8Submatch(t,e){let s=this.allMatches(R.fromUTF8(t),e,n=>{let r=new Array(n.length/2|0).fill(null);for(let a=0;a<r.length;a++)n[2*a]>=0&&(r[a]=t.slice(n[2*a],n[2*a+1]));return r});return s.length===0?null:s}findAllUTF8SubmatchIndex(t,e){let s=this.allMatches(R.fromUTF8(t),e);return s.length===0?null:s}findAllSubmatch(t,e){let s=this.allMatches(R.fromUTF16(t),e,n=>{let r=new Array(n.length/2|0).fill(null);for(let a=0;a<r.length;a++)n[2*a]>=0&&(r[a]=t.substring(n[2*a],n[2*a+1]));return r});return s.length===0?null:s}findAllSubmatchIndex(t,e){let s=this.allMatches(R.fromUTF16(t),e);return s.length===0?null:s}},i1=class i{static isUpperCaseAlpha(t){return"A"<=t&&t<="Z"}static isHexadecimal(t){return"0"<=t&&t<="9"||"A"<=t&&t<="F"||"a"<=t&&t<="f"}static getUtf8CharSize(t){let e=t.charCodeAt(0);return e<128?1:e<2048?2:e<65536?3:4}static translate(t){if(typeof t!="string")return t;let e="",s=!1,n=t.length;n===0&&(e="(?:)",s=!0);let r=0;for(;r<n;){let a=t[r];if(a==="\\"){if(r+1<n)switch(a=t[r+1],a){case"\\":{e+="\\\\",r+=2;continue}case"c":{if(r+2<n){let h=t[r+2];if(i.isUpperCaseAlpha(h)){e+="\\x",e+=(h.charCodeAt(0)-64>>4).toString(16).toUpperCase(),e+=(h.charCodeAt(0)-64&15).toString(16).toUpperCase(),r+=3,s=!0;continue}}e+="\\c",r+=2;continue}case"u":{if(r+2<n){let h=t[r+2];if(i.isHexadecimal(h)){e+="\\x{"+h,r+=3;for(let p=0;p<3&&r<n&&(h=t[r],!!i.isHexadecimal(h));++r,++p)e+=h;e+="}",s=!0;continue}else if(h==="{"){e+="\\x",r+=2,s=!0;continue}}e+="\\u",r+=2;continue}default:{e+="\\";let h=i.getUtf8CharSize(a);e+=t.substring(r+1,r+1+h),r+=h+1;continue}}}else if(a==="/"){e+="\\/",r+=1,s=!0;continue}else if(a==="("&&r+2<n&&t[r+1]==="?"&&t[r+2]==="<"&&(r+3>=n||t[r+3]!=="="&&t[r+3]!=="!")){e+="(?P<",r+=3,s=!0;continue}let o=i.getUtf8CharSize(a);e+=t.substring(r,r+o),r+=o}return s?e:t}},y=class i{static CASE_INSENSITIVE=1;static DOTALL=2;static MULTILINE=4;static DISABLE_UNICODE_GROUPS=8;static LONGEST_MATCH=16;static quote(t){return C.quoteMeta(t)}static quoteReplacement(t,e=!1){return B.quoteReplacement(t,e)}static translateRegExp(t){return i1.translate(t)}static compile(t,e=0){let s=t;if((e&i.CASE_INSENSITIVE)!==0&&(s=`(?i)${s}`),(e&i.DOTALL)!==0&&(s=`(?s)${s}`),(e&i.MULTILINE)!==0&&(s=`(?m)${s}`),(e&~(i.MULTILINE|i.DOTALL|i.CASE_INSENSITIVE|i.DISABLE_UNICODE_GROUPS|i.LONGEST_MATCH))!==0)throw new V("Flags should only be a combination of MULTILINE, DOTALL, CASE_INSENSITIVE, DISABLE_UNICODE_GROUPS, LONGEST_MATCH");let n=g.PERL;(e&i.DISABLE_UNICODE_GROUPS)!==0&&(n&=-129);let r=new i(t,e);return r.re2Input=n1.compileImpl(s,n,(e&i.LONGEST_MATCH)!==0),r}static matches(t,e){return i.compile(t).testExact(e)}static initTest(t,e,s){if(t==null)throw new Error("pattern is null");if(s==null)throw new Error("re2 is null");let n=new i(t,e);return n.re2Input=s,n}constructor(t,e){this.patternInput=t,this.flagsInput=e}reset(){this.re2Input.reset()}flags(){return this.flagsInput}pattern(){return this.patternInput}re2(){return this.re2Input}matches(t){return this.testExact(t)}matcher(t){return Array.isArray(t)&&(t=_.utf8(t)),new B(this,t)}test(t){return Array.isArray(t)?this.re2Input.matchUTF8(t):this.re2Input.match(t)}testExact(t){let e=Array.isArray(t)?R.fromUTF8(t):R.fromUTF16(t);return this.re2Input.executeEngine(e,0,g.ANCHOR_BOTH,0)!==null}split(t,e=0){let s=this.matcher(t),n=[],r=0,a=0;for(;s.find();){if(a===0&&s.end()===0){a=s.end();continue}if(e>0&&n.length===e-1)break;if(a===s.start()){if(e===0){r+=1,a=s.end();continue}}else for(;r>0;)n.push(""),r-=1;n.push(s.substring(a,s.start())),a=s.end()}if(e===0&&a!==s.inputLength()){for(;r>0;)n.push(""),r-=1;n.push(s.substring(a,s.inputLength()))}return(e!==0||n.length===0)&&n.push(s.substring(a,s.inputLength())),n}toString(){return this.patternInput}programSize(){return this.re2Input.numberOfInstructions()}groupCount(){return this.re2Input.numberOfCapturingGroups()}namedGroups(){return this.re2Input.namedGroups}equals(t){return this===t?!0:t===null||this.constructor!==t.constructor?!1:this.flagsInput===t.flagsInput&&this.patternInput===t.patternInput}};function x1(i){let t=0;return i.includes("i")&&(t|=y.CASE_INSENSITIVE),i.includes("m")&&(t|=y.MULTILINE),i.includes("s")&&(t|=y.DOTALL),t}function L1(i){return y.translateRegExp(i)}var X=class{_re2;_pattern;_flags;_global;_ignoreCase;_multiline;_lastIndex=0;_nativeRegex=null;_matcher=null;_matcherInput=null;acquireMatcher(t){return this._matcher===null?(this._matcher=this._re2.matcher(t),this._matcherInput=t,this._matcher):(this._matcherInput!==t&&(this._matcher.matcherInput.charSequence=t,this._matcherInput=t),this._matcher.reset(),this._matcher)}constructor(t,e=""){this._pattern=t,this._flags=e,this._global=e.includes("g"),this._ignoreCase=e.includes("i"),this._multiline=e.includes("m");try{let s=L1(t),n=x1(e);this._re2=y.compile(s,n)}catch(s){if(s instanceof m){let n=s.message||"",r="";throw n.includes("(?=")||n.includes("(?!")||n.includes("(?<")||n.includes("(?<!")||t.includes("(?=")||t.includes("(?!")||t.includes("(?<=")||t.includes("(?<!")?r=" Lookahead (?=, ?!) and lookbehind (?<=, ?<!) assertions are not supported in this environment because the regex engine uses RE2 for ReDoS protection. RE2 guarantees linear-time matching but cannot support these features.":(n.includes("backreference")||/\\[1-9]/.test(t))&&(r=" Backreferences (\\1, \\2, etc.) are not supported in this environment because the regex engine uses RE2 for ReDoS protection. RE2 guarantees linear-time matching but cannot support backreferences."),new SyntaxError(`Invalid regular expression: /${t}/: ${n}${r}`)}throw s}}test(t){return this._global&&(this._lastIndex=0),this.acquireMatcher(t).find()}exec(t){let e=this.acquireMatcher(t),s=this._global?this._lastIndex:0;if(!e.find(s))return this._global&&(this._lastIndex=0),null;let n=this._re2.groupCount(),r=[];r.push(e.group(0)??"");for(let h=1;h<=n;h++){let p=e.group(h);r.push(p)}let a=r;a.index=e.start(0),a.input=t;let o=this._re2.namedGroups();if(o&&Object.keys(o).length>0){let h=Object.create(null);for(let[p,f]of Object.entries(o)){let A=e.group(f);A!==null&&(h[p]=A)}a.groups=h}return this._global&&(this._lastIndex=e.end(0),e.start(0)===e.end(0)&&this._lastIndex++),a}match(t){if(this._global&&(this._lastIndex=0),!this._global)return this.exec(t);let e=[],s=this._re2.matcher(t),n=0;for(;s.find(n);){let r=s.group(0)??"";if(e.push(r),n=s.end(0),s.start(0)===s.end(0)&&n++,n>t.length)break}return e.length>0?e:null}replace(t,e){if(this._global&&(this._lastIndex=0),typeof e=="string"){let p=this._re2.matcher(t);return this._global?p.replaceAll(e,!0):p.replaceFirst(e,!0)}let s=[],n=this._re2.matcher(t),r=0,a=0,o=this._re2.groupCount(),h=this._re2.namedGroups();for(;n.find(a);){s.push(t.slice(r,n.start(0)));let p=[],f=n.group(0)??"";for(let A=1;A<=o;A++)p.push(n.group(A));if(p.push(n.start(0)),p.push(t),h&&Object.keys(h).length>0){let A=Object.create(null);for(let[N,O]of Object.entries(h))A[N]=n.group(O)??"";p.push(A)}if(s.push(e(f,...p)),r=n.end(0),a=r,n.start(0)===n.end(0)&&a++,!this._global||a>t.length)break}return s.push(t.slice(r)),s.join("")}split(t,e){return e===void 0||e<0?this._re2.split(t,-1):e===0?[]:this._re2.split(t,-1).slice(0,e)}search(t){let e=this._re2.matcher(t);return e.find()?e.start(0):-1}*matchAll(t){if(!this._global)throw new Error("matchAll requires global flag");this._lastIndex=0;let e=this._re2.matcher(t),s=this._re2.groupCount(),n=this._re2.namedGroups(),r=0;for(;e.find(r);){let a=[];a.push(e.group(0)??"");for(let h=1;h<=s;h++)a.push(e.group(h));let o=a;if(o.index=e.start(0),o.input=t,n&&Object.keys(n).length>0){let h=Object.create(null);for(let[p,f]of Object.entries(n)){let A=e.group(f);A!==null&&(h[p]=A)}o.groups=h}if(yield o,r=e.end(0),e.start(0)===e.end(0)&&r++,r>t.length)break}}get native(){if(!this._nativeRegex)try{this._nativeRegex=new RegExp(this._pattern,this._flags)}catch{this._nativeRegex=new RegExp("",this._flags),Object.defineProperty(this._nativeRegex,"source",{value:this._pattern,writable:!1})}return this._nativeRegex}get source(){return this._pattern}get flags(){return this._flags}get global(){return this._global}get ignoreCase(){return this._ignoreCase}get multiline(){return this._multiline}get lastIndex(){return this._lastIndex}set lastIndex(t){this._lastIndex=t}};function I1(i,t=""){return new X(i,t)}var r1=class{_regex;constructor(t){this._regex=t}test(t){return this._regex.global&&(this._regex.lastIndex=0),this._regex.test(t)}exec(t){return this._regex.exec(t)}match(t){return this._regex.global&&(this._regex.lastIndex=0),t.match(this._regex)}replace(t,e){return this._regex.global&&(this._regex.lastIndex=0),t.replace(this._regex,e)}split(t,e){return t.split(this._regex,e)}search(t){return t.search(this._regex)}*matchAll(t){if(!this._regex.global)throw new Error("matchAll requires global flag");this._regex.lastIndex=0;let e=this._regex.exec(t);for(;e!==null;)yield e,e[0].length===0&&this._regex.lastIndex++,e=this._regex.exec(t)}get native(){return this._regex}get source(){return this._regex.source}get flags(){return this._regex.flags}get global(){return this._regex.global}get ignoreCase(){return this._regex.ignoreCase}get multiline(){return this._regex.multiline}get lastIndex(){return this._regex.lastIndex}set lastIndex(t){this._regex.lastIndex=t}};export{I1 as a,r1 as b};
